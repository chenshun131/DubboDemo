...
<title>用户统登录</title>
<link href="<%=basePath%>/statics/dwz/themes/css/login.css" rel="stylesheet" type="text/css" />
<style type="text/css">
...
<body>
	<div id="login">
		...
		<div id="login_content">
			...
			<div class="login_banner"><img src="<%=basePath%>/statics/dwz/themes/default/images/login_banner.jpg" /></div>
